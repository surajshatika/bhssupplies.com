...
@section('canonical'){{ route('locations.scarborough') }}@endsection
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "{{ route('locations.scarborough') }}#service",
  "name": "Wholesale HVAC & Plumbing Supplies — Scarborough",
  "description": "BHS Supplies provides wholesale HVAC equipment, sheet metal duct fittings, PEX pipe, gas valves, and plumbing supplies for licensed contractors in Scarborough and east-end Toronto. Accessible via Highway 401 West.",
  "url": "{{ route('locations.scarborough') }}",
  "serviceType": "Wholesale HVAC & Plumbing Supply",
  "areaServed": {"@type": "City", "name": "Scarborough", "addressCountry": "CA"},
