...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        // Multi-channel AddToCart (Meta + TikTok + Pinterest + Snapchat + LinkedIn + X + Google Ads)
        try {
            $eventId = \App\Services\Marketing\MarketingEventDispatcher::eventId('AddToCart', $product->id . '_' . ($cart->id ?? session()->getId()));
            app(\App\Services\Marketing\MarketingEventDispatcher::class)->dispatch('AddToCart', [
                'product'      => $product,
                'value'        => (float) $price,
            ...
            \Log::warning('[CartController] Marketing dispatch failed: ' . $e->getMessage());
        }
