    ...
    <div>
            ...
            <div class="perf-section-body">
                <div class="perf-action-grid">
                    <form action="{{ route('performance_optimizer.images.webp') }}" method="POST" class="perf-action">
                        ...
                        <button class="btn btn-soft-primary" type="submit"><i class="las la-image"></i> {{ translate('Convert 100 → WebP') }}</button>
                    </form>
        ...
        <div class="perf-section">
            <div class="perf-section-header">
                ...
                <a href="{{ route('performance_optimizer.logs') }}" class="btn btn-link btn-sm p-0">{{ translate('View all') }} →</a>
            </div>
    ...
    <div>
        <div class="perf-tips">
            ...
            <div class="perf-tips-body">
                ...
                <p><strong>{{ translate('Enable Page Cache') }}</strong> — {{ translate('static HTML delivery is 10× faster than re-rendering PHP for every visit.') }}</p>
