{{-- ===========================================================
     ...
     Loaded after first paint/interaction to keep render time low.
     =========================================================== --}}
...
window.perfThirdParty(function () {
    window._linkedin_partner_id = "{{ env('LINKEDIN_PARTNER_ID') }}";
...
window.perfThirdParty(function () {
    ...
    googleAdsScript.src = 'https://www.googletagmanager.com/gtag/js?id=AW-{{ env('GOOGLE_ADS_CUSTOMER_ID') }}';
