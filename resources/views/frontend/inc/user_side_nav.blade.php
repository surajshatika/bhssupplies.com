    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('active_ecommerce_support_board') && get_setting('support_board_tickets_status') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('support_board.tickets') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['support_board.tickets']) }}">
                            <i class="las la-ticket-alt fs-16"></i>
                            <span class="aiz-side-nav-text ml-3">{{ translate('Support Tickets') }}</span>
                        </a>
                    </li>
                @endif
