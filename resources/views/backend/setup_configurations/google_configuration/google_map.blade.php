                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div id="map-auth-error" class="alert alert-warning mb-3">
                                        {{ translate('Google Maps could not load. Check that the Map API key is valid, Maps JavaScript API and Places API are enabled, billing is active, and localhost/127.0.0.1 is allowed in HTTP referrer restrictions.') }}
                                    </div>
                                    <input id="searchInput" class="form-control mb-2" type="text" placeholder="{{ translate('Enter a location') }}">
                                    <div id="map"></div>
                                </div>
                                <ul id="geoData">
