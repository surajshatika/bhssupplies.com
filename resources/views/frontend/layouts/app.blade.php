...
@endphp
    ...
    <script type="application/ld+json">
    {
      ...
      "knowsAbout": [
        "HVAC supplies", "AC supplies", "Sheet metal duct fittings", "Flexible ductwork",
        "ACR tubing", "Disconnect boxes", "AC capacitors", "Armaflex insulation",
        "Liquidtite conduit and connectors", "Brackets and bolts", "AC brackets",
        ...
        "Knipex hand tools", "Knipex plumbing tools", "Knipex industrial tools",
        "Knipex HVAC tools", "Knipex electric tools", "Knipex automotive tools",
        "Unilite inspection lights", "Unilite work lights", "Unilite headlamps",
        "Professional lighting tools", "Safety lighting",
        "Excalibur water softeners", "Reverse osmosis systems", "UV water treatment",
        "Water filters", "Water treatment systems"
      ],
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Wholesale HVAC, Plumbing, Tools & Water Treatment Supplies",
        "itemListElement": [
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Sheet Metal Duct Fittings", "url": "{{ url('/category/hvac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Flexible Duct R4.2 R6 R8", "url": "{{ url('/category/hvac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "ACR Tubing", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Disconnect Box", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "AC Capacitors", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Armaflex Insulation", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Liquidtite and Connectors", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Brackets and Bolts", "url": "{{ url('/category/ac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "PEX Pipe All Sizes", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Brass Fittings and Valves", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Copper Pipes and Fittings", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Black Iron Pipes and Fittings", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Gas Valves and CSST Flexible Gas Piping", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Refrigerants R-410A R-32 R-454B", "url": "{{ url('/category/hvac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Air Filters All Sizes", "url": "{{ url('/category/hvac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Thermostats and Controls", "url": "{{ url('/category/hvac-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Water Heater Parts", "url": "{{ url('/category/plumbing-supplies') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Knipex Plumbing and HVAC Hand Tools", "url": "{{ url('/category/knipex') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Knipex Industrial and Electrical Tools", "url": "{{ url('/category/knipex') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Unilite Inspection and Work Lights", "url": "{{ url('/category/unilite-tools') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Unilite Headlamps and Safety Lighting", "url": "{{ url('/category/unilite-tools') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Excalibur Water Softeners", "url": "{{ url('/category/excalibur-water-systems') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "Reverse Osmosis Systems", "url": "{{ url('/category/excalibur-water-systems') }}"}},
          {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "UV Water Treatment Systems", "url": "{{ url('/category/excalibur-water-systems') }}"}},
