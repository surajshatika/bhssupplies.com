        ...
        <div class="p-3">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <input type="text" class="form-control mb-3 rounded-0 d-none checkout-manual-city" name="billing_city_name" placeholder="{{ translate('Enter your city') }}" disabled>
                    <button type="button" class="btn btn-link p-0 mb-3 fs-13 js-toggle-manual-city" data-select-name="billing_city_id" data-input-name="billing_city_name">
                        {{ translate('City not listed? Enter manually') }}
                    </button>
                </div>
            </div>
