            ...
            <div
                ...
                <a href="{{ route('product', $related_product->slug) }}" title="">
                    <img class="lazyload img-fit m-auto has-transition product-main-image"
                        ...
                        alt="{{ $related_product->name }}" loading="lazy" onerror=" this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                    ...
                    <img class="lazyload img-fit m-auto has-transition product-main-image product-hover-image position-absolute"
                        ...
                        title="" loading="lazy" onerror=" this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                </a>
            </div>
            <div class="mt-2 pr-3">
