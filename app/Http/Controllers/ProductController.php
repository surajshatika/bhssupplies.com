...
class ProductController extends Controller
{
    ...
    public function all_products(Request $request)
    {
        ...
        if ($request->filled('subcategory_id')) {
            ...
            $products = $products->whereHas('categories', function ($q) use ($subcategory_id) {
                $q->where('categories.id', $subcategory_id);
            });
        }
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $type = 'In House';
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'type', 'selectedCategoryIds'));
    }
