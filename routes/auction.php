...
use App\Http\Controllers\AddonFallbackController;
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    if (class_exists(AuctionProductController::class)) {
    ...
    if (class_exists(AuctionProductBidController::class)) {
...
Route::group(['middleware' => ['auth']], function() {
    if (class_exists(AuctionProductBidController::class)) {
        ...
        Route::get('/auction_product_bids', [AddonFallbackController::class, 'unavailable'])->name('auction_product_bids.index');
        Route::post('/auction_product_bids', [AddonFallbackController::class, 'unavailable'])->name('auction_product_bids.store');
    }
    ...
    if (class_exists(AuctionProductController::class)) {
        ...
        Route::get('/auction/purchase_history', [AddonFallbackController::class, 'unavailable'])->name('auction_product.purchase_history');
    }
});
...
if (class_exists(AuctionProductController::class)) {
    ...
    Route::get('/auction-product/{slug}', [AddonFallbackController::class, 'unavailable'])->name('auction-product');
    Route::get('/auction-products', [AddonFallbackController::class, 'unavailable'])->name('auction_products.all');
}
