...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="aizSubmitForm">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-lg-8">
                                @php $selectedCategoryIds = old('category_ids', $selectedCategoryIds ?? [$product->category_id]); @endphp
                                <input type="hidden" name="category_id" id="main_category_id" value="{{ old('category_id', $selectedCategoryIds[0] ?? $product->category_id) }}">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">
                                {{translate('Short Description')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i>
...
<!--                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <button type="button" id="btn-generate-meta" class="btn btn-sm btn-soft-primary" onclick="autoGenerateMetaTags()">
                                    <i class="las la-magic"></i> {{ translate('Auto Generate Meta Tags with AI') }}
                                    <span class="spinner-border spinner-border-sm d-none" role="status"></span>
                                </button>
                                <small class="d-block text-muted mt-1">{{ translate('AI will read the product name and description to write optimized meta tags.') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="meta_title" id="meta_title"
                                       ...
                                       maxlength="70" oninput="analyzeSEO()">
                                <div class="d-flex justify-content-between mt-1">
                                    <small class="text-muted">{{ translate('Ideal: 50–60 chars') }}</small>
                                    <small id="prod-title-count" class="font-weight-600 text-warning">{{ strlen($product->meta_title ?? '') }} / 60</small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea name="meta_description" id="meta_description" rows="5"
                                          ...
                                          oninput="analyzeSEO()">{{ $product->meta_description }}</textarea>
                                <div class="d-flex justify-content-between mt-1">
                                    <small class="text-muted">{{ translate('Ideal: 150–160 chars') }}</small>
                                    <small id="prod-desc-count" class="font-weight-600 text-warning">{{ strlen($product->meta_description ?? '') }} / 160</small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="d-flex justify-content-between mt-1">
                                    <small class="text-muted">{{ translate('Ideal: 50–60 chars') }}</small>
                                    <small class="font-weight-600 text-warning">{{ strlen($product->meta_title ?? '') }} / 60</small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="d-flex justify-content-between mt-1">
                                    <small class="text-muted">{{ translate('Ideal: 150–160 chars') }}</small>
                                    <small class="font-weight-600 text-warning">{{ strlen($product->meta_description ?? '') }} / 160</small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="col-12">
                <div class="mb-3 text-right">
                    @include('backend.amazon.partials.upload_button', ['product' => $product])
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.status == 'success') {
                    ...
                    AIZ.plugins.notify('success', '{{ translate('Meta tags generated successfully!') }}');
                } else {
                    AIZ.plugins.notify('danger', data.message || '{{ translate('Failed to generate meta tags') }}');
                }
            },
            error: function() {
