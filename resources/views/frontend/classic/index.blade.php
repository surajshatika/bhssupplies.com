...
<!-- Cupon -->
@if (false && get_setting('coupon_system') == 1)
<div class="mb-2 mb-md-3 mt-2 mt-md-3"
...
{{-- SEO Content Section: below-fold descriptive text for search engines --}}
<section class="py-5 bg-white border-top">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8">
                <h2 class="h4 font-weight-bold mb-3">Canada's Trusted Wholesale HVAC, Plumbing &amp; Electrical Distributor</h2>
                <p class="text-gray-dark mb-3">BHS Supplies is Mississauga's premier wholesale distributor serving HVAC contractors, plumbers, electricians, and building trades professionals across Canada. We stock thousands of SKUs from leading manufacturers — available for same-day pickup or fast national shipping.</p>

                <div class="row mt-4">
                    <div class="col-sm-6 mb-4">
                        <h3 class="h6 font-weight-bold mb-2">HVAC Supplies</h3>
                        <p class="text-muted fs-14 mb-0">Air conditioners, furnaces, heat pumps, ductwork, thermostats, refrigerants, coils, blower motors, and all HVAC parts and accessories. We carry residential and commercial HVAC equipment at wholesale prices.</p>
                    </div>
                    <div class="col-sm-6 mb-4">
                        <h3 class="h6 font-weight-bold mb-2">Plumbing Supplies</h3>
                        <p class="text-muted fs-14 mb-0">Pipes, fittings, valves, water heaters, pumps, backflow preventers, and plumbing fixtures. Whether you need copper, PVC, or PEX materials, we have everything a licensed plumber needs on the job.</p>
                    </div>
                    <div class="col-sm-6 mb-4">
                        <h3 class="h6 font-weight-bold mb-2">Electrical Supplies</h3>
                        <p class="text-muted fs-14 mb-0">Wire, conduit, panels, breakers, outlets, switches, lighting, and electrical accessories. Our electrical inventory is stocked for contractors and electricians at competitive wholesale rates.</p>
                    </div>
                    <div class="col-sm-6 mb-4">
                        <h3 class="h6 font-weight-bold mb-2">Why Choose BHS Supplies?</h3>
                        <ul class="text-muted fs-14 pl-3 mb-0">
                            <li>Wholesale pricing for trade professionals</li>
                            <li>Large inventory — in stock &amp; ready to ship</li>
                            <li>Knowledgeable staff with industry expertise</li>
                            <li>Fast shipping across Canada</li>
                            <li>Mississauga showroom &amp; will-call pickup</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                <div class="bg-light rounded p-4">
                    <h3 class="h6 font-weight-bold mb-3">Serving Trades Professionals Since Day One</h3>
                    <p class="text-muted fs-14 mb-3">Contractors, plumbers, electricians, and property managers across the Greater Toronto Area and Ontario trust BHS Supplies for reliable product availability and wholesale value.</p>
                    <p class="text-muted fs-14 mb-3">We serve residential new construction, commercial retrofits, industrial maintenance, and emergency service calls. Our team understands the urgency of your projects — that's why we keep stock deep and turnaround fast.</p>
                    <p class="text-muted fs-14 mb-0"><strong>Location:</strong> Mississauga, Ontario<br>
                    <strong>Shipping:</strong> Canada-wide<br>
                    <strong>Customer Types:</strong> Contractors, Wholesalers, Property Managers</p>
                </div>
            </div>
        </div>
    </div>
