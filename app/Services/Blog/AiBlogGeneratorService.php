...
class AiBlogGeneratorService
{
    ...
    private function generateBlogContent(
        ...
        $prompt = "Write a local SEO service-page blog post about: {$topic}\n"
            ...
            . "Local service area: {$primaryLocations}, {$secondaryLocations}, GTA, {$country}\n"
            . "Category: {$category}\n"
            ...
            . "5. <h2>Serving {$primaryLocations} and the GTA</h2> - paragraph listing all primary and secondary cities served, weave in location + category keywords\n"
