...
@section('canonical'){{ route('locations.vaughan') }}@endsection
...
<script type="application/ld+json">
{
  ...
  "description": "BHS Supplies provides wholesale HVAC equipment, sheet metal duct fittings, PEX pipe, gas valves, and plumbing supplies for licensed contractors in Vaughan, Woodbridge, and York Region. Approximately 20 minutes via Highway 400.",
  "url": "{{ route('locations.vaughan') }}",
  "serviceType": "Wholesale HVAC & Plumbing Supply",
  "areaServed": {"@type": "City", "name": "Vaughan", "addressCountry": "CA"},
