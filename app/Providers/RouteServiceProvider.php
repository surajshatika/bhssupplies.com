...
class RouteServiceProvider extends ServiceProvider
{
  ...
  /**
   * Define the "Performance Optimizer" routes for the application.
   */
  ...
  /**
   * Define the "Support Board" routes for the application.
   */
  protected function mapSupportBoardRoutes()
  {
    Route::middleware('web')
       ->namespace($this->namespace)
       ->group(base_path('routes/support_board.php'));
  }
