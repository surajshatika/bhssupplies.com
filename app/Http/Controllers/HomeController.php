...
class HomeController extends Controller
{
    ...
    public function product(Request $request, $slug)
    {
        ...
        if ($detailedProduct != null && $detailedProduct->published) {
            ...
            // Multi-channel ViewContent (Meta + TikTok + Pinterest + Snapchat + LinkedIn + X + Google Ads)
            try {
                $eventId = \App\Services\Marketing\MarketingEventDispatcher::eventId('ViewContent', $detailedProduct->id . '_' . session()->getId());
                app(\App\Services\Marketing\MarketingEventDispatcher::class)->dispatch('ViewContent', [
                    'product'      => $detailedProduct,
                    'value'        => (float) home_discounted_price($detailedProduct),
