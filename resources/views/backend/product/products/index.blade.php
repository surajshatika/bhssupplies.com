...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            @endif
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="category_id" id="category_id" onchange="get_subcategories_by_category()">
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="subcategory_id" id="subcategory_id" onchange="sort_products()">
                        ...
                        <td>
                            <div class="row gutters-5 w-200px w-md-300px mw-100">
                                ...
                                <div class="col">
                                    ...
                                    @php $sku = $product->stocks->first()?->sku; @endphp
                                    @if($sku)
                                        <br><small class="text-secondary font-weight-600">SKU: {{ $sku }}</small>
                                    @endif
                                </div>
                            </div>
                        </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function get_subcategories_by_category(){
            ...
            if(category_id != ''){
                $.get('{{ route('products.get_subcategories_by_category') }}', {category_id:category_id}, function(data){
                    $('#subcategory_id').html('<option value="">{{ translate('Sub Category') }}</option>');
