                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','add_digital_product','edit_digital_product','product_bulk_import',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.import.products.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.import.products.index']) }}">
                                    <i class="las la-file-import aiz-side-nav-icon" style="font-size:13px;"></i>
                                    <span class="aiz-side-nav-text">{{ translate('AI Import (PDF/URL)') }}</span>
                                </a>
                            </li>
 ...
 <!-- Refund addon -->
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        {{-- Google Reviews (direct Places API integration, no 3rd-party script) --}}
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('google-reviews-config') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Google Reviews')}}</span>
                            </a>
                        </li>
                        @if (get_setting('google_reviews_enabled') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('google-reviews-dashboard') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Google Reviews Dashboard')}}</span>
                            </a>
                        </li>
                        @endif
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('pixels-capi-hub') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Pixels & CAPI Hub')}} <span class="badge badge-soft-success ml-1" style="font-size:9px;">7 ch</span></span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('analytics.insights.dashboard') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('AI Insights')}} <span class="badge badge-soft-primary ml-1" style="font-size:9px;">AI</span></span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('analytics.attribution.dashboard') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Attribution & Funnels')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('analytics.campaigns.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('UTM Campaign Manager')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('analytics.experiments.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('A/B Testing Lab')}} <span class="badge badge-soft-warning ml-1" style="font-size:9px;">Lab</span></span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('AI Chat Support') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('support_board.conversations') }}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['support_board.conversations','support_board.conversation']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Conversations') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('support_board.settings') }}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['support_board.settings']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Settings') }}</span>
                            </a>
                        </li>
                    </ul>
                ...
                <!-- AI SEO Suite -->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo-suite.index','admin.seo.ai_board.index','admin.seo.monitoring.index','admin.seo_on_page.index','admin.seo_off_page.index','admin.seo_optimization.index','admin.seo-suite.settings.view']) }}">
                        <div class="aiz-side-nav-icon">
                            <i class="las la-chart-line" style="font-size:18px;color:#575b6a;"></i>
                        </div>
                        <span class="aiz-side-nav-text">{{ translate('AI SEO Suite') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo-suite.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo-suite.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo.ai_board.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo.ai_board.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('AI SEO Board') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo.monitoring.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo.monitoring.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Monitoring') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo_on_page.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo_on_page.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('On-Page SEO') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo_off_page.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo_off_page.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Off-Page SEO') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo_optimization.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo_optimization.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Optimization Tools') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.seo-suite.settings.view') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.seo-suite.settings.view']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Global Settings') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.index','admin.social.settings','admin.social.logs','admin.social.campaigns','admin.social.compose']) }}">
                        <div class="aiz-side-nav-icon">
                            <i class="las la-share-alt" style="font-size:18px;color:#575b6a;"></i>
                        </div>
                        <span class="aiz-side-nav-text">{{ translate('Social Media (AI)') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.social.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.social.compose') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.compose']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Compose & Schedule') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.social.campaigns') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.campaigns']) }}">
                                <span class="aiz-side-nav-text">{{ translate('AI Campaigns') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.social.logs') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.logs']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Post Logs') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.social.settings') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.social.settings']) }}">
                                <span class="aiz-side-nav-text">{{ translate('API Settings') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <!-- AI Blog Automation -->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['admin.ai-blog.index','admin.ai-blog.settings']) }}">
                        <div class="aiz-side-nav-icon">
                            <i class="las la-pen-nib" style="font-size:18px;color:#575b6a;"></i>
                        </div>
                        <span class="aiz-side-nav-text">{{ translate('AI Blog (Auto)') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.ai-blog.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.ai-blog.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.ai-blog.settings') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.ai-blog.settings']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Settings') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                ...
                <!-- Amazon Integration -->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.index','amazon.products','amazon.category-mapping','amazon.orders','amazon.logs']) }}">
                        <div class="aiz-side-nav-icon">
                            <i class="las la-shopping-bag" style="font-size:18px;color:#FF9900;"></i>
                        </div>
                        <span class="aiz-side-nav-text">{{ translate('Amazon') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('amazon.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('amazon.products') }}" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.products']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Listed Products') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('amazon.category-mapping') }}" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.category-mapping']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Category Mapping') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('amazon.orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.orders']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Orders') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('amazon.logs') }}" class="aiz-side-nav-link {{ areActiveRoutes(['amazon.logs']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Sync Logs') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
