...
use App\Services\Seo\OnPage\OnPageSeoService;
...
class GenerateOnPageSeoJob implements ShouldQueue
{
    ...
    {
        $this->runId = $runId;
        $this->onQueue(config('seo.queue.on_page', 'default'));
    }
    ...
    public function handle()
    {
        ...
        try {
            $service = new OnPageSeoService($run->provider);
