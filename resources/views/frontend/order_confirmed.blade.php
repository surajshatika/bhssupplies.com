...
@section('script')
    ...
    <!-- Facebook Pixel purchase Event (deduplicated with CAPI via event_id) -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof fbq !== 'function') return;
            var contentIds = @json($combined_order->orders->flatMap(function($o) {
                return $o->orderDetails->pluck('product_id');
            ...
            fbq('track', 'Purchase', {
                ...
                num_items: {{ (int) $combined_order->orders->sum(fn($o) => $o->orderDetails->count()) }}
            }, {
                eventID: 'purchase_{{ $combined_order->id }}'
            });
        });
    </script>
